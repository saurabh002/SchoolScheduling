    ...
    public class SchoolDbContext(DbContextOptions<SchoolDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ClassSection>().HasData(
                ...
                new ClassSection { Id = 6, Name = "1F" },
                new ClassSection { Id = 7, Name = "2A" },
                new ClassSection { Id = 8, Name = "2B" },
                new ClassSection { Id = 9, Name = "2C" },
                new ClassSection { Id = 10, Name = "2D" },
                new ClassSection { Id = 11, Name = "2E" },
                new ClassSection { Id = 12, Name = "2F" },
                new ClassSection { Id = 13, Name = "3A" },
                new ClassSection { Id = 14, Name = "3B" },
                new ClassSection { Id = 15, Name = "3C" },
                new ClassSection { Id = 16, Name = "3D" },
                new ClassSection { Id = 17, Name = "3E" },
                new ClassSection { Id = 18, Name = "3F" },
                new ClassSection { Id = 19, Name = "4A" },
                new ClassSection { Id = 20, Name = "4B" },
                new ClassSection { Id = 21, Name = "4C" },
                new ClassSection { Id = 22, Name = "4D" },
                new ClassSection { Id = 23, Name = "4E" },
                new ClassSection { Id = 24, Name = "4F" },
                new ClassSection { Id = 25, Name = "5A" },
                new ClassSection { Id = 26, Name = "5B" },
                new ClassSection { Id = 27, Name = "5C" },
                new ClassSection { Id = 28, Name = "5D" },
                new ClassSection { Id = 29, Name = "5E" },
                new ClassSection { Id = 30, Name = "5F" }
            );
